...
public class CustomerRepository {
    ...
    public void clearDB() {
        ...
        jdbcTemplate.update("DELETE from customera",namedParameters);
    ...
    public void save(Customer customer) {
        ...
        jdbcTemplate.update("INSERT INTO customera VALUES ( :customernumber, :name, :email, :phone)",namedParameters);
    ...
    public Customer getCustomer(int customerNumber){
        ...
        Customer customer = jdbcTemplate.queryForObject("SELECT * FROM customera WHERE "
    ...
    public List<Customer> getAllCustomers(){
        List<Customer> customers = jdbcTemplate.query("SELECT * FROM customera",
